 ...
 <div className='md:text-2xl text-base balme'>
  ...
  <div className='lg:hidden flex space-x-10'>
    {!dropDown ? (
      ...
      <div className=' border-b border-l border-black bg-[#aeaeae] bg-opacity-20 backdrop-blur-xl p-4 animate-slide-in text-[#aeaeae] font-light absolute top-1/2 left-[90%] transition-all duration-700 ease-in-out transform -translate-x-1/2 overflow-hidden'>
